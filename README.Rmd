...
For macOS and Ubuntu, first download GLFW from either the [GLFW website](https://www.glfw.org) or via [this link](https://github.com/glfw/glfw/releases/download/3.3.2/glfw-3.3.2.zip).
...
If you're installing GLFW via `brew`, remove the `3` from the the `-lgfw3` library 
